...
</c:if> <spring:hasBindErrors name="pasoGuiaTramite">
  <div class="errorBox">
  <ul>
...
<div id="formulario">
<form:form name="form" method="post" commandName="pasoGuiaTramite">
	  ...
	  <p class="odd">
		<label for="urlImg" class="campo">nombre:</label>
      <form:input path="urlImg" />
    </p>
