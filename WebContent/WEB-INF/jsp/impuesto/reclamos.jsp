...
<p class="descripcion-titulo"> es una base de datos en l�nea concebida para aportar una total transparencia en los procedimientos administrativos en Bolivar</p>
...
<div class="row collapse in" id="demo" style="margin-left:350px;margin-right:50px">
  <div class="col-lg-6">
    <div class="input-group">
      ...
      <input id="idReclamo" type="text" class="form-control" placeholder="Ingrese n�mero de Reclamo">
    </div><!-- /input-group -->
  </div><!-- /.col-lg-6 -->
</div><!-- /.row -->
