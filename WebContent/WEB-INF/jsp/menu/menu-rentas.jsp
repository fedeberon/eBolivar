        ...
        <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
                ...
                <div class="caption">
                    ...
                    <form:form action="../../webapp/padron/search" modelAttribute="searchObject" method="POST">
                        <div class="input-group">
                            <div class="input-group-btn">
                                <a href="<c:url value='/webapp/padron/list'/>" class="btn btn-default">
                                    Todos
                                </a>
                                <a href="<c:url value='/webapp/padron/create'/>" class="btn btn-default">
                            ...
                            <input type="text" name="padron.numero" class="form-control tool process" placeholder="Nro. padron" tabindex="5"/>
                        </div><!-- /input-group -->
                    </form:form>
