...
<div id="formulario">
    ...
    <div class="row">
        ...
        <form:form action="../../../../eBolivar/webapp/ddjj/save" modelAttribute="ddjj" method="post">
            <div class="col-md-4">
            ...
            <div class="col-md-8">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <form:select items="${tasas}" class="tasa" path="tasas[0].tasa.id" itemValue="id" id="select-actividad"/>
