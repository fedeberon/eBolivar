...
<div id="formulario">
    ...
    <div class="row">
        ...
        <form:form action="/rentas/webapp/ddjj/getUltimaDeclaracionPorCUIT" method="post" commandName="ddjj">

            <div class="col-md-4">
                <div class="form-group">
                    <label>PADR&Oacute;N:</label>
                    <form:input path="padron.numero" cssClass="form-control" placeholder="Ingrese numero Padron ej:00579500"/>
                    <form:errors path="padron.numero"/>
                </div>

                <div class="form-group">
                    <label>CUIT:</label>
                    <form:input path="persona.idPersona" cssClass="form-control" placeholder="Ingrese numero de CUIT sin guiones" maxlength="11"/>
                    <form:errors path="persona.idPersona"/>
                </div>
            </div>
