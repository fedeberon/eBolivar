...
public class PasoGuiaTramiteUpdateFormController extends SimpleFormController {
	...
	public PasoGuiaTramiteUpdateFormController() {
		setCommandName("pasoGuiaTramite");
		setCommandClass(PasoGuiaTramite.class);
		setFormView("pasoGuiaTramite/update");
	...
	protected Object formBackingObject(HttpServletRequest req) throws Exception {
		PasoGuiaTramite pasoGuiaTramite;
				
		int id;
		try {
			id = Integer.parseInt(req.getParameter("idPasoGuiaTramite"));
		} catch (NullPointerException e) { id = 0;}
		pasoGuiaTramite = (PasoGuiaTramite) pasoGuiaTramiteService.getObject(id);
		return pasoGuiaTramite;
	}
}
