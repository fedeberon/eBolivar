package com.eBolivar.service.autenticacion;// El Departamento de Seguridad Informatica de la AFIP (DeSeIn/AFIP), pone a disposicion
...
public class afip_wsaa_client {
		...
		static String invoke_wsaa (byte [] LoginTicketRequest_xml_cms, String endpoint){
		...
		public static String create_LoginTicketRequest (String SignerDN, String dstDN, String service) {
			...
			exptime.setTime(new Date(GenTime.getTime() +  240000));
