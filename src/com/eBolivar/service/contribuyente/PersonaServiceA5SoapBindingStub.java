...
@Service
public class PersonaServiceA5SoapBindingStub extends org.apache.axis.client.Stub implements com.eBolivar.service.contribuyente.PersonaServiceA5_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(com.eBolivar.service.contribuyente.PersonaReturn.class);
        ...
        oper.setReturnClass(com.eBolivar.service.contribuyente.DummyReturn.class);
    ...
    public PersonaServiceA5SoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = com.eBolivar.service.contribuyente.Actividad.class;
            ...
            cachedSerQNames.add(qName);
            cls = com.eBolivar.service.contribuyente.Categoria.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.eBolivar.service.contribuyente.DatosGenerales.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.eBolivar.service.contribuyente.DatosMonotributo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.eBolivar.service.contribuyente.DatosRegimenGeneral.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.eBolivar.service.contribuyente.Dependencia.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.eBolivar.service.contribuyente.Domicilio.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.eBolivar.service.contribuyente.DummyReturn.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.eBolivar.service.contribuyente.ErrorConstancia.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.eBolivar.service.contribuyente.ErrorMonotributo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.eBolivar.service.contribuyente.ErrorRegimenGeneral.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.eBolivar.service.contribuyente.Impuesto.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.eBolivar.service.contribuyente.Metadata.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.eBolivar.service.contribuyente.PersonaReturn.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.eBolivar.service.contribuyente.Regimen.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.eBolivar.service.contribuyente.Relacion.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public com.eBolivar.service.contribuyente.PersonaReturn getPersona(java.lang.String token, java.lang.String sign, long cuitRepresentada, long idPersona) throws java.rmi.RemoteException {
        try {
            ...
            super.cachedEndpoint = new URL("https://aws.afip.gov.ar/sr-padron/webservices/personaServiceA5");
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {token, sign, new java.lang.Long(cuitRepresentada), new java.lang.Long(idPersona)});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.eBolivar.service.contribuyente.PersonaReturn) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.eBolivar.service.contribuyente.PersonaReturn) org.apache.axis.utils.JavaUtils.convert(_resp, com.eBolivar.service.contribuyente.PersonaReturn.class);
            }
        }
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (com.eBolivar.service.contribuyente.DummyReturn) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.eBolivar.service.contribuyente.DummyReturn) org.apache.axis.utils.JavaUtils.convert(_resp, com.eBolivar.service.contribuyente.DummyReturn.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
