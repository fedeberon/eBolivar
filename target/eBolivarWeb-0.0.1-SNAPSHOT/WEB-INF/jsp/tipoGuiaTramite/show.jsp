...
<html>
<head>
<title>${initParam['AppName']} - Ver TipoGuiaTramite</title>
...
<body>
	...
	<table id="listado" class="tablesorter" border="0" cellpadding="0" cellspacing="1">
		...
		<tbody>
			...
			<tr>
		<td><b>codigo:</b></td>
		<td>${tipoGuiaTramite.codigo}</td>
	</tr><tr>
		<td><b>nombre:</b></td>
		<td>${tipoGuiaTramite.nombre}</td>
	</tr>
	...
	<div id="botonera">
		...
		<a class="button" href="update?idTipoGuiaTramite=${tipoGuiaTramite.id}">
